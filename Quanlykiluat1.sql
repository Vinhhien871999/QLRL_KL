...
go
CREATE procedure spgetMaLop (@MaLop nchar(10))
as
begin
...
as
	begin
		update Hocvien_Phanloairenluyen
		set Thoigian =@Thoigian,MaHV= @MaHV,MaPLRL =@MaPLRL,MaGS =@MaGS
		,Boi =@Boi,Chaydai =@Chaydai,Chayngan =@Chayngan,nhayxa=@nhayxa,xa=@xa
		where Mahv_plrl = @Mahv_plrl
	end
go
create proc spgettableplrl
as
	begin
		select * from Hocvien_Phanloairenluyen
	end
go
...
go
insert into Phanloaikiluat
values('PLKL001','Giỏi')
insert into Phanloaikiluat
values('PLKL002','Khá')
insert into Phanloaikiluat
values('PLKL003','Trung bình')
insert into Phanloaikiluat
values('PLKL004','Không đạt')
go
create proc spgettableplkl
as
	begin
		select * from HocVien_Phanloaikiluat
	end
go
create proc insert_HVKL
	@Mahv_plkl nchar(10),
	@Thoigian datetime,
	@MaHV nchar(10),
	@MaPLKL nchar(10),
...
as
	begin
		insert into HocVien_Phanloaikiluat(Mahv_plkl,Thoigian,MaHV,MaPLKL,Capdanhgia,Nguoidanhgia,Diemkiluat,Diemhoctap,Diemloisong,Diemhoatdongdoan)
		values (@Mahv_plkl,@Thoigian,@MaHV,@MaPLKL,@Capdanhgia,@Nguoidanhgia,@Diemkiluat,@Diemhoctap,@Diemloisong,@Diemhoatdongdoan)
	end
go
create proc update_HVKL
	@Mahv_plkl nchar(10),
	@Thoigian datetime,
	@MaHV nchar(10),
	@MaPLKL nchar(10),
...
as
	begin
		update HocVien_Phanloaikiluat
		set Thoigian =@Thoigian,MaHV= @MaHV,MaPLKL =@MaPLKL,Capdanhgia =@Capdanhgia
		,Nguoidanhgia =@Nguoidanhgia,Diemkiluat =@Diemkiluat,Diemhoctap =@Diemhoctap,Diemloisong=@Diemloisong,Diemhoatdongdoan=@Diemhoatdongdoan
		where Mahv_plkl = @Mahv_plkl
	end
go
select * from HocVien_Phanloaikiluat
go
create proc spgettablequychuanRl
as
	begin
		select top(5) * from Quychuan		
	end
go
create proc spgettablequychuanKL
as
	begin
...
insert into Quychuan
values('QC0001',N'chạy dài',N'phút','13','14','15')
insert into Quychuan
values('QC0002',N'chạy ngắn',N'giây','13','14','15')
insert into Quychuan
values('QC0003',N'xà',N'cái','20','17','15')
insert into Quychuan
values('QC0004',N'bơi',N'phút','3','4','5')
insert into Quychuan
values('QC0005',N'nhảy xa',N'mét','13','14','15')
insert into Quychuan
values('QC0006',N'Điểm DG',N'Điểm','9','8','7')
insert into Quychuan
values('QC0007',N'Điểm KL',N'Điểm','9','8','7')
insert into Quychuan
values('QC0008',N'Điểm HT',N'Điểm','9','8','7')
insert into Quychuan
values('QC0009',N'Điểm LS',N'Điểm','9','8','7')
go
create proc getmaplkl
as
	begin
		select MaPLKL from Phanloaikiluat
	end
go
create proc getmaplrl
as
	begin
		select MaPLRL from Phanloairenluyen
	end
go

create proc spgettablegiamsat
as
	begin
		select * from giamsat
	end
